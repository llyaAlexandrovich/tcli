# Tcli execution process eplanation  



# Overview  

## Tcli claims to be secure and reliable and therefore tries to put YOU in the first place. This means NO EXTERNAL SERVICES ARE REQUIRED while using TCli. TCli will only connect to Telegram© servers. No additional services at all. No metrics. No telemetry. Nothing that you don't like.  

...
if __name__ == "__main__":
    ...
    InternalEnv = os.environ["PATH"]
    InternalEnvDict = InternalEnv.split(';')
    ...
    if "mingw" and "cmake" not in InternalEnv.lower():
        logging.critical("Lack of dependencies")
        logging.critical("GCC-14, G++-14 and CMake-4.2 required to build this project")
    ...
    # Run program 3 times before exitins with error critical.
    counter = 0
    ...
    logging.critical("Program ran out of attempts - 3/3")
    logging.critical("Dependencies not resolved")
